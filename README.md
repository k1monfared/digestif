...
- Searching keeps only the matches and their ancestor path visible: matches keep the highlight ring, the parent chain stays as a faded skeleton, and every other node and edge is hidden until the search is cleared.
